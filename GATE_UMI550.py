...
OUT_PATH  = "/Users/2025/Documents/David/raw_files/cleanedcodetest.RAW"
#23.5 ps = ~77.2cm/1024(bits) -> //speed of light -> x10
TDC_BIN_PS = 23.5
...
#there should be no bias in GATE
bias = int(np.median(dt_bins))
dt_bins = np.clip(dt_bins - bias, -512, 511)

#pack 10 bits as lower 5 and upper 5
